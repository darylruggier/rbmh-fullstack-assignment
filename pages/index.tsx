  ...
  return (
    <div className="h-screen w-screen flex justify-center items-center">
      <div className="flex flex-col w-3/4 h-96 justify-start items-center shadow-2xl rounded-lg">
        <img className="py-12" src="../../assets/rbmh-logo.png" alt="Red Bull Media House" />
        <input value={email} type="email" className="w-3/4 h-12 border-black border rounded-lg mt-4 p-2" onChange={(e) => setEmail(e.target.value)} placeholder="Email" />
        <input value={password} type="password" className="w-3/4 h-12 border-black border rounded-lg mt-4 p-2" onChange={(e) => setPassword(e.target.value)} placeholder="Password" />
