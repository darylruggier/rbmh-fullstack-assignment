...
const LargeButton: React.FC<Props> = ({ label, onClick, disabled, isLoading}) => {
  return (
    <button disabled={disabled || isLoading} className="w-full h-12 rounded-md mt-6 bg-rb-red-inactive text-white disabled:bg-[#E2E3E5] transition duration-200 hover:bg-rb-red-active" onClick={onClick}>
